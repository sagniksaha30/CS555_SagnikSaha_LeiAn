...
%
% This scripts computes the N^2 nodes and weights for a triangle 
% with vertices given by the 3x2 vector v. The nodes are produced 
% by collapsing the square to a triangle. 
%
% Sample Usage: 
%
